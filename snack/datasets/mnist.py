...
class MNIST2KDataset(Dataset):
    """MNIST2k dataset."""

    def __init__(self, txt_file, label_file, transform=None):
        """
        Args:
        ...
        self.labels = np.array(np.loadtxt(label_file).tolist(), dtype=np.int)
